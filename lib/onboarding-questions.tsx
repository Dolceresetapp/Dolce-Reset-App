...
export const emotionalQuestions: EmotionalQuestion[] = [
  ...
  },
  {
    ...
    subtitle: "We are taking this to calculate your BMI",
    type: "input",
    inputType: "number",
    placeholder: "e.g. 165",
    min: 120,
  ...
  },
  {
    ...
    title: "Your Current BMI Analysis",
    type: "custom-screen",
  ...
  },
  {
    ...
    subtitle: "Enter your goal weight in kilograms (kg)",
    type: "input",
    inputType: "number",
    placeholder: "e.g. 60",
    min: 30,
  ...
  },
  {
    ...
    title: "Your Target BMI Analysis",
    type: "custom-screen",
