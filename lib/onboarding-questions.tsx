    ...
    options: [
      {
        ...
        image: "/improvedbody/2.webp",
      },
      {
        id: "get_fit",
        label: "RIMETTERSI IN FORMA",
        image: "/improvedbody/13.webp",
      },
      {
        id: "better_sleep",
        label: "Migliorare sonno / energia",
        image: "/improvedbody/4.webp",
      },
      {
        id: "improve_aches",
        label: "Ridurre dolori / rigidità",
        image: "/improvedbody/5.webp",
      },
    ],
  },
  {
    ...
    options: [
      {
        id: "belly_face",
        label: "Addome e viso",
        image: "/bodyparts/8.webp",
      },
      {
        id: "legs",
        label: "Gambe",
        image: "/bodyparts/11.webp",
      },
      {
        id: "back_posture",
        label: "Schiena / Postura",
        image: "/bodyparts/9.webp",
      },
      {
        id: "full_body",
        label: "Corpo intero",
