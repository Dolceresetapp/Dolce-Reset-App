...
class IbsWidget extends StatefulWidget {
  double ibsValue;

  IbsWidget({super.key, required this.ibsValue});

  @override
  State<IbsWidget> createState() => _IbsWidgetState();
}

class _IbsWidgetState extends State<IbsWidget> {
  @override
        ...
        children: [
          Align(
            ...
            child: Row(
              ...
              children: [
                Text(
                  widget.ibsValue.toStringAsFixed(0).toString(),
