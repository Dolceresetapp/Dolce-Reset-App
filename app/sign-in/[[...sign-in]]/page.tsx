      ...
      <div className="signin-wrapper">
        <div className="signin-card">
          <div className="signin-header">
            ...
            <p className="">Sign in to continue your fitness journey</p>
          </div>
          <SignIn
            appearance={{
              elements: {
          ...
          {/* add sign up */}
          <br/>
          <center><span className="senior-text-sm">Don't have an account? <Link href="/sign-up" className="text-white/70">Sign Up</Link></span></center>
        </div>
      </div>
    </div>
  )
